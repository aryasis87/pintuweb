...
export const faqItems: FaqItem[] = [
  ...
  { category: 'technical', question: 'Bagaimana keamanan website dijamin?', answer: 'Semua website dilengkapi SSL certificate, security headers, input validation, dan backup otomatis. Kami monitoring berkala dan update security patch. Untuk e-commerce, kami tambahkan additional security layer.', tags: ['keamanan', 'ssl', 'security'] },
  ...
  { category: 'support', question: 'Apakah ada garansi?', answer: 'Ya, garansi 30 hari untuk bug fixes dan technical issues. Selain itu kami provide lifetime support untuk konsultasi dan maintenance guidance. Jika ada masalah teknis, kami perbaiki gratis.', tags: ['garansi', 'support', 'maintenance'] },
  { category: 'support', question: 'Bagaimana cara update konten website setelah jadi?', answer: 'Kami provide training update konten via dashboard admin (paket Business+) atau bisa request update ke kami kapan saja. Update minor seperti teks, gambar, atau info kontak kami bantu gratis via WhatsApp.', tags: ['update', 'konten', 'training'] },
